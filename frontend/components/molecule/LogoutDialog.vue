...
async function handleLogoutOperation() {
...
<template>
  <div>
    <TransitionRoot as="template" :show="logoutStore.status">
      <Dialog class="relative z-10" @close="logoutStore.close()">
        <TransitionChild
          as="template"
        ...
        <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
          ...
          >
            ...
            >
              ...
              >
                <div
                  class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4 dark:bg-gray-900"
                >
                ...
                <div
                  class="px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6 dark:bg-gray-900"
                >
                  <button
